<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/back_end/back_CSS_JS/assets/vendors/iconly/bold.css">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/back_end/back_CSS_JS/assets/vendors/perfect-scrollbar/perfect-scrollbar.css">
