...
<ul>
  <li><a href='<%=request.getContextPath()%>/back_end/consultation/listAllConsult.jsp'>諮詢表單列表</a><br><br></li>
  ...
  <li>
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back_end/consultation/consult.do" >
        ...
        <input type="submit" class="btn btn-outline-secondary btn-sm" value="送出">
    </FORM>
  <br></li>
...
<br>
<ul>
  <li><a href='addConsult.jsp'>新增諮詢表單</a></li>
</ul>
</div>
</div>
</section>
