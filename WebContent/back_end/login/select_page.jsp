                ...
                <div class="row">
                    ...
                    <h3>查詢員工 :<br></h3>
                        ...
                        <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/staff/staff.do" >
                            <label for="basicInput">輸入員工編號</label>
                            <input type="text" class="form-control" id="basicInput" name="staff_no">
...
<div class="form-group">
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/staff/staff.do" >
                      <label for="helpInputTop">選擇員工編號 : </label>
                        <select size="1" name="staff_no" class="btn btn-secondary dropdown-toggle me-1" >
  ...
  <br>
                     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/staff/staff.do" >
                        <div class="form-group">
                            <label for="helperText">選擇員工姓名 :</label>
                            <select size="1" name="staff_no" class="btn btn-secondary dropdown-toggle me-1">
                            <c:forEach var="staffVO" items="${staffSvc.all}" > 
                    ...
                    <div class="col-md-6">
                    <h3>新增員工&<br>查詢個人員工資訊 :</h3>
                    
                    <div class="form-group">
                            <label for="disabledInput">新增員工</label>
                            <br>
                           <div><a href="<%=request.getContextPath()%>/back_end/staff/addStaff.jsp">新增</a> a new Staff.</div>
                        </div>
                        <br>
                        <br>
            
                        <div class="form-group">
                            <label for="disabledInput">員工個人資料修改</label>
                            <br>
                           <div><a href="<%=request.getContextPath()%>/back_end/staff/update_One_Staff.jsp">修改</a>  Staff</div>
                        </div>
                        <br>
                        <br>
                        <div class="form-group">
                            <label for="disabledInput">員工個人資料查詢</label>
                            <br>
                           <div><a href="<%=request.getContextPath()%>/back_end/staff/listOneStaff.jsp">查詢</a>  Staff</div>
                        </div>
<br>
<br>

                        <div class="form-group">
                        <label for="disabledInput">全體員工資料查詢</label>
                        <br>
