...
<script>
    function showPrDetail(data,data2){
    	document.open('<%=request.getContextPath()%>/back_end/rep/rep.do?rep_no='+data2+'&pr_no='+data+'&action=getOnePr_For_DisplayDetail', '' ,'height=500,width=500,left=800,top=200,resizable=yes,scrollbars=yes');
   	}   
</script>
</body>
</html>