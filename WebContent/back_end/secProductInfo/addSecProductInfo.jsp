								...
								<div class="row">
									...
									<div class="col-md-8 form-group">									
										<select class="form-select" id="basicSelect" name="spc_no">
											<c:forEach var="ClassVO" items="${classSvc.all}">
                                            	<option value="${ClassVO.spc_no}" ${(ClassVO.spc_no == productInformVO.spc_no)? 'selected':'' }>${ClassVO.spc_name}</option>                                           		
                                           </c:forEach>
                                    	</select>
									</div>
									<div class="col-md-4">
									...
									<div class="col-md-8 form-group">
										<select class="form-select" id="basicSelect" name="spi_sta">
                                            <option value = "上架" ${( "上架" == productInformVO.spi_sta)? 'selected':'' }>上架</option>
                                            <option value = "下架" ${( "下架" == productInformVO.spi_sta)? 'selected':'' }>下架</option>
                                    	</select>	
									</div>
